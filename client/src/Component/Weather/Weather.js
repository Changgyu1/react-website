...
function Weather() {
  ...
  useEffect(() => {
    ...
    if (navigator.geolocation) {
      ...
      console.error("내 위치 정보를 가지고 올 수 없습니다.");
    }
  }, []);
